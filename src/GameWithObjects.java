...
public class GameWithObjects extends PApplet {
    ...
    public void setup() {
        ...
        shot = new Abilities(50, 50, 10, "[ ]");
        myFont = createFont("Georgia", 24);
        homefont = createFont("Georgia", 56);
        textFont(homefont);
        textFont(myFont);
    ...
    public void draw() {
        ...
        fill(0, 255, 0);
        rect(300, 300, 30, 30);
        text("Welcome", 430, 400);
        text("Click here to ", 355, 475);
        text("begin your Mortal Combat", 320, 500);
        fill(255, 0, 0);
        ...
        if (GameStart) {
            ...
            if (player2.mana > 200)
                player2.mana = 200;
            rect(0, 100, shot.x, shot.y);
            fill(255, 0, 0);
            text(shot.a, 5, 130);
            text("L", 880, 130);

            // long t1 = System.nanoTime();
            // text((t1 - start)/ 1000000000, 20, 150);
            if (counter3 == 30) {
                if (counter2 > 0) {
                    counter2--;
                }
            ...
            if (key == 'l') {
                if (counter4 == 0) {
                    if (player2.mana < 190) {
                        ...
                        if (player2.x >= player.x) {
                            Specials2 bill = new Specials2(player2.x - 10,
                                    player2.y);
